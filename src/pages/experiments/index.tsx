    ...
    <>
      ...
      <div className="prose mx-auto mt-4 flex w-full flex-col items-center justify-start font-sans text-foreground prose-headings:text-center prose-headings:text-foreground">
        ...
        <div className="container flex min-h-fit w-96 flex-col items-center justify-start rounded-lg  p-6">
          {/** Ripple Animation */}
          <section className="flex h-fit min-h-fit w-full min-w-fit flex-col  items-center  justify-center rounded-md border bg-gray-200 p-8 dark:bg-slate-700 ">
          ...
          <section className="flex h-fit min-h-fit w-full min-w-fit flex-col  items-center  justify-center rounded-md border bg-gray-200 p-8 dark:bg-slate-700 ">
            ...
            <div className="bg-anim-diagonal h-48 w-full  bg-gradient-to-br from-sky-500 to-red-500 "></div>
          </section>
        </div>
      </div>
    </>
